    ...
    >
      ...
      <div className="flex-1 relative">
        <Select value={category} onValueChange={setCategory} onOpenChange={(open) => setIsFocused(open)}>
          <SelectTrigger 
            className="w-full bg-transparent border-none shadow-none outline-none text-gray-800 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 px-0 py-0 h-auto"
          >
            <SelectValue placeholder="Explore government schemes by category..." />
          </SelectTrigger>
          <SelectContent>
